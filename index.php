            ...
            <div class="col-lg-4 col-md-6">
                <div class="card h-100 border-0 shadow-sm text-center">
                    ...
                    <div class="card-body p-4">
                        ...
                        <a id="btn-servicio-hardware" href="/omning/servicios.php" class="text-decoration-none fw-bold" style="color: var(--color-secundario);">Saber más <i class="fa-solid fa-arrow-right ms-1"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card h-100 border-0 shadow-sm text-center">
                    ...
                    <div class="card-body p-4">
                        ...
                        <a id="btn-servicio-software" href="/omning/servicios.php" class="text-decoration-none fw-bold" style="color: var(--color-secundario);">Saber más <i class="fa-solid fa-arrow-right ms-1"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card h-100 border-0 shadow-sm text-center">
                    ...
                    <div class="card-body p-4">
                        ...
                        <a id="btn-ver-portafolio" href="/omning/portafolio.php" class="text-decoration-none fw-bold" style="color: var(--color-secundario);">Ver proyectos <i class="fa-solid fa-arrow-right ms-1"></i></a>
                    </div>
                </div>
            </div>
        </div>
