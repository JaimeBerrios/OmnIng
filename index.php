        ...
        <div class="row align-items-center g-4 g-md-5">
            <div class="col-lg-6 order-2 order-lg-1">
                ...
                <div class="d-flex flex-column flex-sm-row gap-3">
                    ...
                    <a id="btn-servicios-hero" href="<?= BASE_URL ?>servicios" class="btn btn-outline-light fw-bold rounded-pill px-4 py-3 border-2 custom-hover-btn">
            ...
            <div class="col-lg-6 order-1 order-lg-2 text-center">
                <img src="<?= BASE_URL ?>assets/img/hero-omning.webp" width="800" height="600" fetchpriority="high" decoding="async" alt="Representación de servicios OmnIng" class="img-fluid rounded-4 shadow-lg border border-primario border-opacity-50">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row g-4">
            <div class="col-lg-4 col-md-6">
                <div class="card h-100 border-0 shadow-sm text-center">
                    <img src="<?= BASE_URL ?>assets/img/servicio-hardware.webp" width="600" height="400" loading="lazy" decoding="async" class="card-img-top img-fluid" alt="Soporte de Hardware">
                    <div class="card-body p-4">
                        ...
                        <a id="btn-servicio-hardware" href="<?= BASE_URL ?>servicios" class="text-decoration-none fw-bold" style="color: var(--color-secundario);">Evaluar mis equipos <i class="fa-solid fa-arrow-right ms-1"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card h-100 border-0 shadow-sm text-center">
                    <img src="<?= BASE_URL ?>assets/img/servicio-software.webp" width="600" height="400" loading="lazy" decoding="async" class="card-img-top img-fluid" alt="Desarrollo de Software">
                    <div class="card-body p-4">
                        <div class="bg-negro rounded-circle d-inline-flex align-items-center justify-content-center mb-3 mt-n5 position-relative shadow" style="width: 70px; height: 70px;">
                        ...
                        <a id="btn-servicio-software" href="<?= BASE_URL ?>servicios" class="text-decoration-none fw-bold" style="color: var(--color-secundario);">Planificar mi sistema <i class="fa-solid fa-arrow-right ms-1"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card h-100 border-0 shadow-sm text-center">
                    <img src="<?= BASE_URL ?>assets/img/casos-exito.webp" width="600" height="400" loading="lazy" decoding="async" class="card-img-top img-fluid" alt="Nuestro Portafolio">
                    <div class="card-body p-4">
                        <div class="bg-negro rounded-circle d-inline-flex align-items-center justify-content-center mb-3 mt-n5 position-relative shadow" style="width: 70px; height: 70px;">
                        ...
                        <a id="btn-ver-portafolio" href="<?= BASE_URL ?>portafolio" class="text-decoration-none fw-bold" style="color: var(--color-secundario);">Revisar proyectos <i class="fa-solid fa-arrow-right ms-1"></i></a>
                    </div>
                </div>
            </div>
        </div>
...
<section class="bg-light py-5">
    <div class="container py-4">
        <div class="row align-items-center g-4 g-md-5">
            ...
            <div class="col-lg-6">
                <img src="<?= BASE_URL ?>assets/img/por-que-elegir-omning.webp" width="600" height="600" loading="lazy" decoding="async" alt="Ingeniería y Soporte OmnIng" class="img-fluid rounded-4 shadow">
            </div>
        </div>
    </div>
</section>
