        ...
        <div class="row g-4">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card h-100 border-0 shadow-sm overflow-hidden rounded-4 custom-hover-card">
                            <div class="position-relative">
                                <img src="<?php echo htmlspecialchars($proyecto['imagen']); ?>" class="card-img-top w-100" alt="<?php echo htmlspecialchars($proyecto['titulo']); ?>" style="height: 240px; object-fit: cover;">
                            ...
                            <div class="card-body p-4 d-flex flex-column">
                                ...
                                <?php if (!empty($proyecto['enlace'])): ?>
                                    <a href="<?php echo htmlspecialchars($proyecto['enlace']); ?>" target="_blank" rel="noopener noreferrer" class="btn btn-outline-dark fw-bold rounded-pill w-100 py-2 border-2 mt-auto">
                                        <i class="fa-solid fa-arrow-up-right-from-square me-2"></i> Ver Proyecto en Vivo
                                    </a>
                                <?php else: ?>
                                    <a href="contacto.php" class="btn btn-light bg-light text-muted fw-bold rounded-pill w-100 py-2 border-0 mt-auto disabled opacity-50">
            ...
            <?php else: ?>
                <div class="col-12 text-center py-5">
                    ...
                    <a href="index.php" class="btn btn-cta fw-bold rounded-pill px-4 py-2 mt-3">Volver al Inicio</a>
                </div>
            <?php endif; ?>
        </div>
    </div>
...
<section class="bg-light py-5 border-top border-secondary border-opacity-10">
    <div class="container py-4 text-center">
        ...
        <a href="contacto.php" class="btn btn-cta btn-lg fw-bold rounded-pill px-5 py-3 shadow">
